class FusionSimulation < Formula
  ...
  url "https://github.com/dahai80/fusion-simulation/releases/download/v0.1.6/fs-release.tar.gz"
  sha256 "a6b66376314617527b63b7bb21d110948c9cecdafbdb8c3ced6a1cba2785d0f6"
  license "Apache-2.0"
